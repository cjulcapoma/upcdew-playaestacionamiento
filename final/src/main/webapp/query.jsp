					...
					<p>Ingrese el rango de fechas que desee consultar con el formato DD/MM/YYYY </p>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>Local</td>
                                                <td colspan="2">
                                                    <input type="text" class="input-normal" name="id_local" value="${usuario.local.nombre}">
                                                    </input></td>
                                            </tr>
                                            </c:if>
                                ...
                                <h2 class="title">Resultado de Consultas</h2>
                                    <div class="story">
                                        <c:if test="${coningsal.fechadesde!=null}">
                                    ...
                                    <table border="0" width="100%"><tr>
                                        ...
                                        <table border="0" width="100%">
                                            <tr>
                                                <c:if test="${querytype=='A'}">
                                                <td width="25%" class = "et">Cliente</td>
                                                </c:if>
                                            ...
                                            <tr>
                                                <c:if test="${querytype=='A'}">
                                             <td>${alquiler.tarjeta.cliente.nombre}</td>
                                                </c:if>
