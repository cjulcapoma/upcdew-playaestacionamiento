...
public class RecargaTarjeta extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Tarjeta oTarjeta = tarjetajdbc.getTarjetabyCliente(String.valueOf(oCliente.getId()));
            ...
            Tarjeta uTarjeta = tarjetajdbc.getTarjetabyCliente(String.valueOf(uoCliente.getId()));
