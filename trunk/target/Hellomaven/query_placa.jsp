    ...
    <body>
        ...
        <div id="wrapper">
            <div id="content">
                <div id="posts">
                    <div class="post">
                        <h2 class="title">Criterios de Consultas por Placa</h2>
                        <div class="story">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <input type=hidden name="tipoconsulta" value="placa"></input>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Desde</td>
                        ...
                        <div class="story">
                            ...
                            <p>Lista de transacciones para desde 01/05/2010 hasta 10/05/2010 para la placa YUY-898</p>
