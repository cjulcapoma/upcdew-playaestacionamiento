...
<div id="wrapper">
	<div id="content">
		<div id="posts">
			<div class="post">
				<h2 class="title">Criterios de Consultas por Periodo</h2>
				<div class="story">
					<p>Ingrese el rango de fechas que desee consultar con el formato DD/MM/YYYY </p>
                                        <table>
                                            <tr>
                                                <td>Local</td>
                                                <td><input type="text" class="input-normal" name="id_local"></input>
                                                    <input type=hidden name="tipoconsulta" value="local"></input>
                                                </td>
                                ...
                                <h2 class="title">Resultado de Consultas por Periodo</h2>
                                    <div class="story">
                                        
                                        <p>Lista de transacciones para desde 01/05/2010 hasta 10/05/2010 </p>
