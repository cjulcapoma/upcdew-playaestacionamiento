...
<!-- end #header -->
<form action="LoginCliente?tipo=C" method="post">
<div id="wrapper">
	<div id="content">
		<div id="posts">
			<div class="post">
				...
				<div class="story">
					<p>Ingrese los datos de acceso</p>
                                        <table >
                                            <tr>
                                                <td>DNI</td>
                                                <td><input type="text" class="input-normal" name="user" value="43633724"></input></td>
                                            </tr>
                                            <tr>
                                                <td>Contraseña</td>
                                                <td>
		...
		<div id="links">
                    <ul>
                        <li>
                            ...
                            <ul>
                                <li><a href="login_user.jsp">Administrativo</a> <i>(User)</i></li>
