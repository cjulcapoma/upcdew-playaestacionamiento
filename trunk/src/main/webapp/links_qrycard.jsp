...
<div id="links">
			<ul>
					...
					<ul>
						...
						<li><a href="ConsultaIngresoSalida?querytype=A">Por Asociado</a> <i>(Clente registrado)</i></li>
					...
					<ul>
                                                <li><a href="ConsultaSaldos?linktype=saldo">Saldos</a> <i>(M)</i></li>
						<li><a href="ConsultaSaldos?linktype=movimiento">Movimientos</a> <i>(A)</i></li>
