	...
	<div id="content">
		<div id="posts">
			...
			<h2 class="title">Criterios de Consultas</h2>
				...
				<div class="story">
                                    <c:if test="${conmov.fechadesde!=null}">
                                    <p> Abonos a la tarjeta del ${conmov.fechadesde} al ${conmov.fechahasta} </p>
                                    </c:if>
                                        ...
                                        <table border="0" width="100%"><tr>
                                                ...
                                                <table border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="25%" class = "et">Fecha Inicio</td>
                                                        <td width="25%" class = "et">Fecha Fin</td>
